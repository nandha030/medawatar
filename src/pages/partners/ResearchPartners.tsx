...
import { Microscope, TestTube, Brain, Database } from 'lucide-react';

const features = [
  {
    icon: TestTube,
    title: 'Clinical Research',
    description: 'Advanced clinical trials and medical research'
  },
  {
    icon: Brain,
    title: 'AI Research',
    description: 'Healthcare AI and machine learning innovation'
  },
  {
    icon: Database,
    title: 'Data Analytics',
    description: 'Big data analytics for healthcare insights'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="flex justify-center mb-8">
            <div className="relative">
              ...
              <div className="relative bg-white p-4 rounded-full">
                <Microscope className="w-12 h-12 text-purple-900" />
              </div>
            </div>
          </div>
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Leading academic and research institutions advancing healthcare
          </p>
        </div>
