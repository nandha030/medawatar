...
const features = [
  {
    ...
    description: 'Military-grade quantum-resistant encryption for medical data'
  },
  {
    icon: Lock,
    title: 'Secure Infrastructure',
    description: 'State-of-the-art security infrastructure and protocols'
  },
  {
    icon: Key,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Leading providers of quantum-secure healthcare data protection
          </p>
        </div>
